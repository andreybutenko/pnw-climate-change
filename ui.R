...
my.ui <- navbarPage(
  ...
  tabPanel("Economy",
           tags$div(
             ...
             tags$img(src = 'http://www.bottomupeconomy.org/wp-content/uploads/2015/11/new-economy.jpg', alt='Map and picture of Olympic National Park park', class = 'image-center leaf-image'),
